...
class extract_beta_structure_coords():
    ...
    def __init__(self, code, resn, rfac, pdb_database):
        self.code = code
        self.resn = resn
        self.rfac = rfac
    ...
    def gen_cd_hit_dict(self, filtered_domain_df):
        ...
        fasta_list = []
        with open('seqid_0.40_globalfilt_CD_HIT_output.txt', 'r') as chain_entries_file:
    ...
    def get_xyz_coords(self, cd_hit_domain_df):
        ...
        # structures file
        with open('Unprocessed_CATH_{}.txt'.format(self.code), 'a') as unprocessed_file:
